                         ...
                         tabItem(tabName = "submission",
                                 ...
                                 fluidRow( align = "center",
                                           ...
                                           box(title = "Provide (or update) a Running Cromwell Server Node and Port",
                                               ...
                                               textInput("cromwellURL", "Current Cromwell host:port (e.g.: `gizmoz45:8000`) ",
                                                         value = ""),
                                               actionButton(inputId = "setCromwellURL",
                                                            label = "Set/Update Cromwell URL",
                                                            icon = icon("refresh")),
                                               verbatimTextOutput(outputId = "currentNodePort"))
                                           ),

                                 fluidRow( align = "center", 
                                           box(width = 6, solidHeader = FALSE, status = "success",
                                               ...
                                               box(title = "Abort a Workflow",
                                                   collapsible = TRUE, collapsed = FALSE,
                                                   width = 6,  solidHeader = FALSE, status = "danger",
